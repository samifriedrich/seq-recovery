# seq-recovery
This script compares transcript sequence alignments of zebra finch and chicken [Ensembl](http://www.ensembl.org) gene models to the zebra finch (*Taeniopygia guttata*) genome assembly [taeGut1](https://genome.ucsc.edu/cgi-bin/hgGateway?db=taeGut1) with the ultimate goal of recovering sequence that may be missing from current zebra finch gene models. (i.e. aligned chicken sequence blocks that do not overlap with any of the corresponding zebra finch model).
